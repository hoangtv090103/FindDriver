...
[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    ...
    public interface IRegister
    {
        ...
        string ReigsterCustomer(string firstName, string lastName, string email, string password, string phone);
...
[ProgId("FindDriver.RegisterService")]
...
public class Register : IRegister {
    ...
    public string ReigsterCustomer(string firstName, string lastName, string email, string password, string phone)
    {
        string connString = new MySQLDBConnection().GetConnectionString();
        using (MySqlConnection conn = new MySqlConnection(connString))
        {
